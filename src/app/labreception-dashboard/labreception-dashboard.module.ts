...
import { EOrderHistoryComponent } from './nurs-treatment-workarea/e-order-main/e-order-history/e-order-history.component';
import { EOrderSearchlistComponent } from './nurs-treatment-workarea/e-order-main/e-order-searchlist/e-order-searchlist.component';
import { CreateEorderComponent } from './nurs-treatment-workarea/e-order-main/create-e-order/create-e-order.component';

const route: Routes = [
  {
    path: '',
    component: LabreceptionDashboardComponent,
  },
];

@NgModule({
  declarations: [
    LabreceptionDashboardComponent,
    CheckInComponent,
    ErBedComponent,
    ErVitalsComponent,
...
export class LabreceptionDashboardModule { }
