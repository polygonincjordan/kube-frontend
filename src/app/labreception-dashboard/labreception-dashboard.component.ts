...
@Component({
  selector: 'app-labreception-dashboard',
  templateUrl: './labreception-dashboard.component.html',
  styleUrls: ['./labreception-dashboard.component.scss']
})
export class LabreceptionDashboardComponent implements OnInit {
