...
@Component({
  ...
  templateUrl: './radiologist-dashboard.component.html',
  styleUrls: ['./radiologist-dashboard.component.scss']
})
export class RadiologistDashboardComponent implements OnInit {
  ...
  isRadiologist: boolean = true;
  radiologistActive: boolean = true;
