...
@UntilDestroy()
@Component({
  selector: 'app-er-diagnosis',
  templateUrl: './diagnosis.component.html',
  styleUrls: ['./diagnosis.component.scss'],
})
export class ERDiagnosisComponent implements OnInit {
  ...
  openModalForDiagnosisKardex(data) {
   this.paramsObject = data;
    //this.emergencyService.tabPanelNavigation('Diagnosis');
    const config: ModalOptions = { class: 'modal-dialog-centered diagnosis-erhistory' };
    this.modalRef = this.modalServiceForAllergy.show(this.diagnosisKardexModal, config);
    this.initForm();
  ...
  creatDiagnosisFormData(): FormGroup {
    ...
    return this.formBuilder.group({
      ...
      DiagSeqno: ['000'],
      ExtDiagno: [''],
      MovemntSeqno: [this.paramsObject.Lfdbw],
      IverDocno: [''],
      DiagCatalog1: ['10'],
      DiagKey1: [null],
      DiagCatalog2: [''],
