...
@Component({
  selector: 'frequency-deftim',
  templateUrl: './frequency-deftim.component.html',
  styleUrls: ['./frequency-deftim.component.scss']
})
export class FrequencyDeftimComponent implements OnInit, OnDestroy {
