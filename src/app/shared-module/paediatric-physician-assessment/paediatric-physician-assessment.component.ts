...
@Component({
  selector: 'app-paediatric-physician-assessment',
  templateUrl: './paediatric-physician-assessment.component.html',
  styleUrls: ['./paediatric-physician-assessment.component.scss']
})
export class PaediatricPhysicianAssessmentComponent implements OnInit {
