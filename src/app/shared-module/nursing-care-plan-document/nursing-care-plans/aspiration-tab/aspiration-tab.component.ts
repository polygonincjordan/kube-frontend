...
@Component({
  selector: 'app-aspiration-tab',
  templateUrl: './aspiration-tab.component.html',
  styleUrls: ['./aspiration-tab.component.scss']
})
export class AspirationTabComponent implements OnInit {
