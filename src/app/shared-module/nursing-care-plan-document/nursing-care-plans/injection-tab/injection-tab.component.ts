...
@Component({
  selector: 'app-injection-tab',
  templateUrl: './injection-tab.component.html',
  styleUrls: ['./injection-tab.component.scss']
})
export class InjectionTabComponent implements OnInit {
