...
@UntilDestroy()
@Component({
  selector: 'app-physician-diagnosis',
  templateUrl: './physician-diagnosis.component.html',
  styleUrls: ['./physician-diagnosis.component.scss']
})
export class PhysicianDiagnosisComponent implements OnInit {
  ...
  openModalForDiagnosisKardex() {
    ...
    const config: ModalOptions = { class: 'modal-dialog-centered diagnosis-kardex' };
