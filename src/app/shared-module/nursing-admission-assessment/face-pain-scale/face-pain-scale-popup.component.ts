...
@Component({
  selector: 'app-face-pain-scale-popup',
  templateUrl: './face-pain-scale-popup.component.html',
  styleUrls: ['./face-pain-scale-popup.component.scss']
})
export class FacePainScalePopupComponent implements OnInit {
