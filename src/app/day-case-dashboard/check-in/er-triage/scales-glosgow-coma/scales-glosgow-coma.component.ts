...
@Component({
  selector: 'app-scales-glosgow-coma',
  templateUrl: './scales-glosgow-coma.component.html',
  styleUrls: ['./scales-glosgow-coma.component.scss'],
})
export class ScalesGlosgowComaComponent implements OnInit {
  ...
  scoreLabel() {
    if (this.verbalScore == 'T') {
      this.totalScoreDescription = `${this.conditionalScoreLabel()} E:${
        this.eyeOpeningScore
