...
@Component({
  selector: 'app-physician-create-allergy',
  templateUrl: './physician-create-allergy.component.html',
  styleUrls: ['./physician-create-allergy.component.scss']
})

export class PhysicianCreateAllergyComponent implements OnInit {
  ...
  constructor(private modalServiceForAllergy: BsModalService,
    private formBuilder: FormBuilder, public storageService: StorageService, private emergencyService: EmergencyService, private sanitizer: DomSanitizer) {
  ...
  public openModalForAllergy() {
    const config: ModalOptions = { class: 'modal-dialog-centered allergy-modal-size', ignoreBackdropClick: true };
    this.modalRefForAllergy = this.modalServiceForAllergy.show(this.allergyModal, config);
