...
import { CreateDischargeOrderComponent } from 'src/app/e-prescription/discharge-order/create-discharge-order/create-discharge-order.component';
...
export class EPrescriptionComponent implements OnInit {
  ...
  constructor(public sidebarService: SidebarService, public eprescriptionService: EPrescriptionService, private route: ActivatedRoute, public emergencyService: EmergencyService) {
    ...
    this.eprescriptionService.tabPanelNavigation('OrderDetails')
