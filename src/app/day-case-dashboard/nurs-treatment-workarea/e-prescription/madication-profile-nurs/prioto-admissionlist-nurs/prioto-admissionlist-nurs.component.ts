...
@Component({
  selector: 'app-prioto-admissionlist-nurs',
  templateUrl: './prioto-admissionlist-nurs.component.html',
  styleUrls: ['./prioto-admissionlist-nurs.component.scss']
})
export class PriotoAdmissionlistNursComponent implements OnInit {
