...
import { ProgressNotesCategoryModel, ProgressNotesListModel, ProgressNotesTemplateModel } from '@services/admission/interfaces/template-model';
...
export class ProgressNoteComponent implements OnInit {
  ...
  saveProgressTemplateData(template: TemplateRef<any>,updateTempName?) {
    ...
    this.admissionService.saveProgressNotesTemplate(saveTemplateData).subscribe(
      (data: any) => {
