...
import { CustomSearchPipe } from '../emergency-dashboard/e-prescription/prior-admission/medications-profile/custom.search.pipe';
import { FilterPipePipe } from '../emergency-dashboard/e-prescription/prior-admission/filter.pipe.pipe';
...
const route: Routes = [
  {
    path: '',
    component: DialysisNursingDashboardComponent,
  },
];
...
@NgModule({
  declarations: [
    ...
    DialysisNursingDashboardComponent,
