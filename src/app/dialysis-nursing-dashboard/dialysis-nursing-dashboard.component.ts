...
@Component({
  selector: 'app-dialysis-nursing-dashboard',
  templateUrl: './dialysis-nursing-dashboard.component.html',
  styleUrls: ['./dialysis-nursing-dashboard.component.scss']
})
export class DialysisNursingDashboardComponent implements OnInit {
  @ViewChild(CheckInComponent) CheckInComponent;
  @ViewChild(BedComponent) BedComponent;
  ...
  navigateToTreatmentArea(checkindata) {
    ...
    if (checkindata.Lfdbw) {
      ...
      window.open(
        'dialysis-nursing-dashboard?' + 'patnr=' +
        checkindata.Patnr +
        '&falnr=' +
        checkindata.Falnr +
        '&einri=' +
    ...
    if (this.selectedModule == 'checkin' ||this.selectedModule == 'bed' || this.selectedModule == 'erhistory' || this.selectedModule == 'LabResults' || this.selectedModule == 'AdministeredDoses') {
      //this.selectModule('treatmentarea');
