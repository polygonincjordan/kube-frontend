  ...
  initForm(data?){
    this.nicuForm = this.formBuilder.group({
      ...
      SSkincolor : [data?.SSkincolor || ''],
        ...
        DpMedications : [data?.DpMedications || ''],
        DpDiet : [data?.DpDiet || ''],
        DpMobility : [data?.DpMobility || ''],
        DpPainManagement : [data?.DpPainManagement || ''],
        DpMedicalEquipment : [data?.DpMedicalEquipment || ''],
        DpHomeSupport : [data?.DpHomeSupport || ''],
        DpSmokingCessation : [data?.DpSmokingCessation || ''],
        DpClinicalAppointments : [data?.DpClinicalAppointments || ''],
        DpOthers : [data?.DpOthers || ''],
        // VitK : [data?.VitK || ''],
        // HepB : [data?.HepB || ''],
