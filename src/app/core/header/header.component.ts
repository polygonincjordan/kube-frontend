...
export class HeaderComponent implements OnInit {
  ...
  redirectToTreatment(data) {
    ...
    } else if ([UserType.ERHospitalist, UserType.SeniorPhysician, UserType.Physician, UserType.FloorHospitalist, UserType.SeniorHospitalist, UserType.Community, UserType.PartTime].includes(userType)) {
  ...
  savePassword() {
    if (this.passform.controls.newPass.value == this.passform.controls.confirmNewPass.value) {
      const json = {
