...
export class ComplexOrderComponent implements OnInit, OnDestroy {
  ...
  generateForm() {
    return new FormGroup({
      ...
      Pdur: new FormControl("0", [Validators.required, Validators.min(0)]),
  ...
  validFromTobaseonDuration(index: number, data: any) {
    if (data.StartD) {
      this.complexArray.controls[index].patchValue({
        StartD: new Date(`${formatDate(data.StartD, "YYYY-MM-DD")}T${data.StartT}`)
      })
      if (`${data.Pdur}` === "0") {
        this.complexArray.controls[index].patchValue({ EndD: null, EndT: null });
      }
      if (data.Pduru !== null && (data.Pduru === "MON" || (this.administrationService.durationUnitList.find(d => d.Text === data.Pduru) !== undefined && this.administrationService.durationUnitList.find(d => d.Text === data.Pduru).Unit === "MON")) && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({
      ...
      if (data.Pduru !== null && (data.Pduru === "TAG" || (this.administrationService.durationUnitList.find(d => d.Text === data.Pduru) !== undefined && this.administrationService.durationUnitList.find(d => d.Text === data.Pduru).Unit === "TAG")) && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({
      ...
      if (data.Pduru !== null && (data.Pduru === "MIN" || (this.administrationService.durationUnitList.find(d => d.Text === data.Pduru) !== undefined && this.administrationService.durationUnitList.find(d => d.Text === data.Pduru).Unit === "MIN")) && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({
      ...
      if (data.Pduru !== null && (data.Pduru === "STD" || (this.administrationService.durationUnitList.find(d => d.Text === data.Pduru) !== undefined && this.administrationService.durationUnitList.find(d => d.Text === data.Pduru).Unit === "STD")) && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({
      ...
      if (data.Pduru !== null && (data.Pduru === "S" || (this.administrationService.durationUnitList.find(d => d.Text === data.Pduru) !== undefined && this.administrationService.durationUnitList.find(d => d.Text === data.Pduru).Unit === "S")) && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({
      ...
      if (data.Pduru !== null && (data.Pduru === "WCH" || (this.administrationService.durationUnitList.find(d => d.Text === data.Pduru) !== undefined && this.administrationService.durationUnitList.find(d => d.Text === data.Pduru).Unit === "WCH")) && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({
      ...
      if (data.Pduru === "DOS" && `${data.Pdur}` !== "0") {
        this.complexArray.controls[index].patchValue({ EndD: null, EndT: null });
        if (data.N1znr !== null) {
          this.onFrequencyFilter(data, index)
        }
      }
    }
  }
