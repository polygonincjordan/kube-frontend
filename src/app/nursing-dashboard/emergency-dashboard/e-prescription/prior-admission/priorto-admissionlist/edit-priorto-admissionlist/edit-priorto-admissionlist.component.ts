...
import { PrnConditionPopupComponent } from 'src/app/nursing-dashboard/emergency-dashboard/e-prescription/discharge-order/prn-condition-popup/prn-condition-popup.component';

@Component({
  selector: 'edit-priorto-admissionlist',
  templateUrl: './edit-priorto-admissionlist.component.html',
  styleUrls: ['./edit-priorto-admissionlist.component.scss']
})
export class EditPriortoAdmissionlistComponent implements OnInit {
  ...
  onEditAction() {
    // if (this.editprofileForm.valid) {
      ...
      delete this.editprofileForm.value.Physicinnm;
      delete this.editprofileForm.value.Indisdos;
      delete this.editprofileForm.value.Formatdescr;
      delete this.editprofileForm.value.Descrlt;
      delete this.editprofileForm.value.Result_Drug_Name;
      const payloadData = {
