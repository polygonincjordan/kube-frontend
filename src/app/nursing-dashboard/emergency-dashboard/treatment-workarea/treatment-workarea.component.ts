...
@Component({
  ...
  templateUrl: './treatment-workarea.component.html',
  styleUrls: ['./treatment-workarea.component.scss']
})
export class TreatmentWorkareaComponent implements OnInit {
  ...
  PhyAccor='collapse';
  SerAccor='collapse';
  constructor(public emergencyService: EmergencyService, private formBuilder: FormBuilder, private _dataServices: EEmrService, public sidebarService: SidebarService,
