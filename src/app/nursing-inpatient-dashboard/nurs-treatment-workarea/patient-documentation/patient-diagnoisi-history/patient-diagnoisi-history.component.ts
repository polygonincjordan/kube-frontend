...
@Component({
  ...
  templateUrl: './patient-diagnoisi-history.component.html',
  styleUrls: ['./patient-diagnoisi-history.component.scss']
})
export class PatientDiagnoisiHistoryComponent implements OnInit {
