    ...
    this.subscription = this.emergencyService.fetchSBARNursingDocument(docKey).subscribe({
      next: (apiResponse: any) => {
        ...
        this.sbarNursingForm.patchValue({
          ...
          Falnr: result?.Falnr || '',
          Lfdnr: result?.Lfdnr || '',
          Orgdo: this.storageService.patientData.deptOrgUnit || this.storageService.patientData.deptOrgUnit,
          AttendPhy: this.storageService.getUserProfile().Gpart || this.storageService.getUserProfile().Gpart,
