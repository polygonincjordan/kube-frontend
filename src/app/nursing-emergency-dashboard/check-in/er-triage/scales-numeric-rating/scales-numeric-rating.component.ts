...
@Component({
  selector: 'app-scales-numeric-rating',
  templateUrl: './scales-numeric-rating.component.html',
  styleUrls: ['./scales-numeric-rating.component.scss'],
})
export class ScalesNumericRatingComponent implements OnInit {
