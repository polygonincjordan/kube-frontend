...
@Component({
  selector: 'app-add-habit-social',
  templateUrl: './add-habit-social.component.html',
  styleUrls: ['./add-habit-social.component.scss'],
})
export class AddHabitSocialComponent implements OnInit {
