...
import { ModetailPanelComponent } from 'src/app/emergency-dashboard/e-prescription/prior-admission/modetail-panel/modetail-panel.component';
import { AdditionInfoPopupComponent } from 'src/app/emergency-dashboard/e-prescription/discharge-order/addition-info-popup/addition-info-popup.component';
import { MedicationsPopupComponent } from 'src/app/emergency-dashboard/e-prescription/prior-admission/medications-popup/medications-popup.component';

@Component({
  selector: 'app-madication-profile-nurs',
  templateUrl: './madication-profile-nurs.component.html',
  styleUrls: ['./madication-profile-nurs.component.scss']
})
export class MadicationProfileNursComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.MedicationorderForm = new FormGroup({
      ...
      patientProfileHistory:new FormControl(true),
    });
