...
@Component({
  selector: 'app-patient-profile-history-nurse',
  templateUrl: './patient-profile-history-nurse.component.html',
  styleUrls: ['./patient-profile-history-nurse.component.scss'],
  providers:[DatePipe]
})
export class PatientProfileHistoryNurseComponent implements OnInit {
